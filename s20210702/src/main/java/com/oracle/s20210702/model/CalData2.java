...
public class CalData2 {
	...
	public Map<String, Integer> today_info(CalData2 cdt2) {
		// 날짜 캘린더 함수에 삽입.
		Map<String, Integer> today_Data = new HashMap<String, Integer>();
		Calendar cal = Calendar.getInstance();
		cal.set(Integer.parseInt(cdt2.getYear()), Integer.parseInt(cdt2.getMonth()), 1);
		...
		int search_year = Integer.parseInt(cdt2.getYear());
		int search_month = Integer.parseInt(cdt2.getMonth()) + 1;
	...
	// 스케줄 사용시 사용될 생성자
	public CalData2(String year, String month, String date, String value, String schedule, String schedule_detail) {
	...
	// 달력만 사용시 사용될 생성자
	public CalData2(String year, String month, String date, String value) {
	...
	public String toString() {
		return "CalData2 [year=" + year + ", month=" + month + ", date=" + date + ", value=" + value + "]";
	}
